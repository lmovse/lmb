...
import info.lmovse.blog.web.controller.admin.AttachController;
...
//            默认是classPath路径
    ...
    public static User getLoginUser(HttpServletRequest request) {
        ...
        return (User) session.getAttribute(AppConst.LOGIN_SESSION_KEY);
    }
    ...
    public static Integer getCookieUid(HttpServletRequest request) {
        if (null != request) {
            Cookie cookie = cookieRaw(AppConst.USER_IN_COOKIE, request);
            if (cookie != null && cookie.getValue() != null) {
                try {
                    String uid = Tools.deAes(cookie.getValue(), AppConst.AES_SALT);
    ...
    public static void setCookie(HttpServletResponse response, Integer uid) {
        try {
            String val = Tools.enAes(uid.toString(), AppConst.AES_SALT);
            boolean isSSL = false;
            Cookie cookie = new Cookie(AppConst.USER_IN_COOKIE, val);
            cookie.setPath("/");
