package info.lmovse.blog.core.util;
...
public final class Commons {
    ...
    public static String site_option(String key, String defalutValue) {
        ...
        String str = AppConst.initConfig.get(key);
    ...
    public static String gravatar(String email) {
        String avatarUrl = "https://avatars2.githubusercontent.com/u/19148311?v=4&u=e53a312968dea33b9ea624ea015bf79606b2730b&s=400";
        if (StringUtils.isBlank(email)) {
            email = "hmilyssy@gmail.com";
        }
    ...
    public static String show_tags(String tags) throws UnsupportedEncodingException {
        if (StringUtils.isNotBlank(tags)) {
            ...
            StringBuilder sbuf = new StringBuilder();
            for (String c : arr) {
                sbuf.append("<a href=\"/tag/").append(URLEncoder.encode(c, "UTF-8")).append("\">").append(c).append("</a>");
            }
            return sbuf.toString();
        }
        return "";
    ...
    public static String show_prev(Integer cid) {
        return "/article/" + siteService.getArticleIndex(cid, "prev");
    }

    public static String show_next(Integer cid) {
        return "/article/" + siteService.getArticleIndex(cid, "next");
    }
    ...
    public static String show_thumb(Content contents) {
        ...
        int size = cid % 20;
        size = size == 0 ? 1 : size;
        return "/user/img/rand/material-" + size + ".png";
    }
    ...
    public static List<MetaDto> categries() {
        return categries(AppConst.MAX_POSTS);
    }
    ...
    public static List<MetaDto> tags() {
        return tags(AppConst.MAX_POSTS);
    }
    ...
    public static Map<String, String> social() {
        ...
        map.put("weibo", AppConst.initConfig.get(prefix + "weibo"));
        map.put("zhihu", AppConst.initConfig.get(prefix + "zhihu"));
        map.put("github", AppConst.initConfig.get(prefix + "github"));
        map.put("twitter", AppConst.initConfig.get(prefix + "twitter"));
        return map;
    }
